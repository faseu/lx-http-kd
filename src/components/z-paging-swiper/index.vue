...
<template>
  <view
    :class="fixed ? 'zp-swiper-container zp-swiper-container-fixed' : 'zp-swiper-container'"
    :style="[finalSwiperStyle]"
  >
    <!-- #ifndef APP-PLUS -->
    ...
    <view class="zp-swiper-super">
      ...
      <view
        :class="{ 'zp-swiper': true, 'zp-absoulte': isOldWebView }"
        :style="[swiperContentStyle]"
      >
        <slot />
      </view>
      <view
        v-if="zSlots.right"
        :class="{ 'zp-swiper-right': true, 'zp-absoulte zp-right': isOldWebView }"
      >
        <slot name="right" />
      </view>
    </view>
